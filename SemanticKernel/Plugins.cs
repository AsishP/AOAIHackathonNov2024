...
{   
    ...
    [Description("""
        Query the database to return data for the given query, if there are no other plugins that can be used to answer the query. This function only return data from the Microsoft AI Tour in Sydney conference.
    ...
    [Description("Return a list of sessions at AI Tour in Sydney at that are similar to a specific topic or by a specific speaker name specified in the provided topic parameter. If no results are found, an empty list is returned. This function only return data from the AI Tour in Sydney conference.")]
